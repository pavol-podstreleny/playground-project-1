// see https://gist.github.com/jamesbar2/1c677c22df8f21e869cca7e439fc3f5ba
const postal = [
  {
...
export function getPostalCodeKeys(): string[] {
  return postal.map((postalCode) => {
    return postalCode.ISO;
  });
}

export function getPostalCodeEURegexp(): RegExp {
  const regs = postal
    .map((postalCode) => {
      if (
